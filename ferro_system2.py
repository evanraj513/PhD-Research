...
#        disc = self.disc
    ...
    def set_up_step_1a_inv(self):
        ...
        self.a1_1lu = linalg.splu(self.a1_1.tocsc())
        self.a1_2lu = linalg.splu(self.a1_2.tocsc())
        self.a1_3lu = linalg.splu(self.a1_3.tocsc())
    ...
    def set_up_step_2a_inv(self):
        ...
        self.a2_1lu = linalg.splu(self.a2_1.tocsc())
        self.a2_2lu = linalg.splu(self.a2_2.tocsc())
        self.a2_3lu = linalg.splu(self.a2_3.tocsc())
...
#        disc = self.disc
    ...
    def single_run_ADI_v2(self,t):
        ...
        # self.H_old.values[0] = self.H_old.x.value*0
        # self.H_old.values[1] = self.H_old.y.value*0
        ...
        # self.H_new.values[0] = self.H_old.x.value*0
        # self.H_new.values[1] = self.H_old.y.value*0
